...
const SearchComp = () => {
  return (
    <div className='searchComp w-[92%] m-auto grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
        ...
        <div className='secDiv flex item-center gap-10 justify-center'>
            <div className="singleSearch">
                <label htmlFor="relevance" className='text-[#808080] font-semibold'>Sort by : </label>
                <select name="relevance" className='bg-white rounded-[3px] px-4 py-1'>
            ...
            <div className="singleSearch">
                ...
                <select name="" className='bg-white rounded-[3px] px-4 py-1'>
            ...
            <div className="singleSearch">
                ...
                <select name="" id='level' className='bg-white rounded-[3px] px-4 py-1'>
                    ...
                    <option value="Remote">Beginner</option>
                    <option value="Contract">Intermediate</option>
                    <option value="Part-Time">Advance</option>
                </select> 
            </div>
